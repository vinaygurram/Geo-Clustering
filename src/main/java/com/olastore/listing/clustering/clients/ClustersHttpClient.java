...
/**
 * Can only execute one operation. Supporting creating resources both from POST
 * and PUT. Not supporting 202 request accepted as valid response.
 * 
 */
